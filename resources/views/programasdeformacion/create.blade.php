    ...
    <div class="col-md-8">
        <div class="card shadow border-0">
            <div class="card-header bg-success text-white py-3">
                <h4 class="mb-0"><i class="bi bi-journal-plus me-2"></i>Registrar Nuevo Programa</h4>
            </div>
                ...
                <form method="POST" action="{{ route('programasdeformacion.store') }}">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <label for="codigo" class="form-label fw-bold">Código del Programa</label>
                            <input type="number" 
                                   id="codigo" 
                                   name="codigo" 
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="observaciones" 
                                  ...
                                  class="form-control" 
                                  rows="3" 
                                  placeholder="Detalles adicionales sobre el programa...">{{ old('observaciones') }}</textarea>
                    </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-4">
                        ...
                        <button type="submit" class="btn btn-success px-5 shadow-sm">
                            <i class="bi bi-check-lg"></i> Guardar Programa
                        </button>
                    </div>
                </form>
            </div>
